//
//  SFSubjectResultsTableViewController.m
//  SciFair
//
...
@implementation SFSubjectResultsTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Person *person = [self.subjects objectAtIndex:indexPath.row];
    cell.textLabel.text = person.name;
    */
    // Configure the cell...
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    // Memory management.
    NSLog(@"Called %@", _fetchedResultsController);
    return _fetchedResultsController;
}
